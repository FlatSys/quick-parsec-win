...
TITLE Parsec Anywhere - https://github.com/FlatSys/quick-parsec-win
...
curl --progress-bar -f https://raw.githubusercontent.com/FlatSys/quick-parsec-win/main/config.txt -o "%temp%\Parsec\config.txt"
...
msg "%username%" /TIME:10 Parsec has been installed to %Temp% and is now running. You can close this window.
